...
if (mongoUri) {
    mongoose.connect(mongoUri)
        ...
        .catch((err) => console.error('Analysis Service DB Connection Error:', err.message));
} else {
    console.error('Analysis Service Error: Neither MONGO_URI nor MONGODB_URI is defined!');
}
